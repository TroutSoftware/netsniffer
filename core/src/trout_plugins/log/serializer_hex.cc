...
// Local includes
#include "serializer_hex.h"

namespace serializer_hex {
namespace {

static const char *s_name = "serializer_hex";
static const char *s_help = "Serializes LioLi trees as hex data";
...
public:
  ...
  bool is_ready() override { return true; }; // We are always ready
