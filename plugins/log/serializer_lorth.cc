...
#include "serializer_lorth.h"

namespace serializer_lorth {
namespace {

static const char *s_name = "serializer_lorth";
static const char *s_help = "Serializes LioLi trees to lorth format";
