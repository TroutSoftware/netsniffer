...
static const char *s_help =
    "filters network trafic and stores it in pcap files";
...
static const snort::Parameter module_params[] = {
    {"snap_length", snort::Parameter::PT_INT, "0:max31", "65536",
     "The snap length used when processing pacages (i.e. max size we process "
     "per package)"},
    ...
    {"map", snort::Parameter::PT_LIST, map_item, nullptr,
     "Map with rules and pcap file prefixes, if a packet matches a rule, it "
     "will be written to the pcap"},
    {nullptr, snort::Parameter::PT_MAX, nullptr, nullptr, nullptr}};
